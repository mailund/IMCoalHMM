...
for sim in `eval echo {1..${no_sims}}`; do
	...
	python /scratch/$SLURM_JOBID/variable-migration-model-mcmc.py -o INMmcmc-$var-simTrees-${sim}-chain.txt -a11 ${simdir}/*.11.ziphmm -a12 ${simdir}/*.12.ziphmm -a22 ${simdir}/*.22.ziphmm --samples 10000 --thinning 10  --sd_multiplyer $var --switch 2
