...
if __name__ == '__main__':
    ...
    cd=VariableCoalAndMigrationRateAndAncestralModel(VariableCoalAndMigrationRateAndAncestralModel.INITIAL_22, intervals=[5,5,5,5], breaktimes=1.0,breaktail=3,time_modifier=time_modifier)
