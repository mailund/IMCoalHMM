...
the isolation period parameter."""
    ...
    parser.add_argument('--isolation-period-end', type=float, required=True,
                        help="Larst point in the range to compute likelihood for.")
    parser.add_argument('--number-of-points', type=int, default=50, nargs=1,
    ...
    initial_parameters = (#init_isolation_time,
                          init_migration_time, init_coal, init_recomb, init_migration)
