...
class VariableCoalAndMigrationRateModel(Model):
    ...
    def emission_points(self, *parameters):
        ...
        break_points = psmc_break_points(self.no_states,mu=0.01) #0.08 is a hunch because on simulated data (10^6 base pairs) mu=10^-9 was too way little and mu=1 was a little too much
    ...
    def build_ctmc_system(self, *parameters):
        ...
        break_points = psmc_break_points(self.no_states, mu=0.01)
